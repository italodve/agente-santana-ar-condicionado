...
1. Clone o repositorio:
   ```bash
   git clone https://github.com/italodve/agente-santana-ar-condicionado.git
   cd agente-santana-ar-condicionado
   ```
...
1. Publique este repositorio no GitHub (ja feito: `italodve/agente-santana-ar-condicionado`).
...
5. Copie a URL gerada pelo Railway e atualize `AI_AGENT_BASE_URL` em
   `script.js` no repositorio `site-santana-ar-condicionado`.
...
{
  "status": "ok",
  "service": "agente-santana-ar-condicionado"
}
```
...
```json
{
  ...
  "lead": [
    ...
    { "label": "Interesse", "value": "instalação" }
  ],
